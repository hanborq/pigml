 ...
 */
public class SVMLoader extends LoadFunc implements LoadMetadata {
	static final Log LOG = LogFactory.getLog(SVMLoader.class);
	private RecordReader<Object, Text> reader;
	private byte fieldDel = '\t';
	private byte kvDel = ' ';
	
	public SVMLoader() throws FrontendException {
		this(" ", ":");
	}
	
	public SVMLoader(String fd, String kvd) throws FrontendException {
